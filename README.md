...
O objetivo desta atividade foi replicar um layout de alta fidelidade utilizando tecnologias web fundamentais, mantendo a identidade visual e a organização do código, seguindo uma única imagem de referência e refazê-la idêntica, não pode ser usado frameworks (Ex. React) 
